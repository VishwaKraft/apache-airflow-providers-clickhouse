...
def get_provider_info():
    return {
        ...
        "name": "Clickhouse",
        "description": "`Clickhouse <https://www.clickhouse.com/>`__\n",
        "state": "ready",
        ...
        "hooks": [
            {"integration-name": "Clickhouse", "python-modules": ["airflow.providers.clickhouse.hooks.clickhouse"]}
        ],
        "operators": [
            {
                "integration-name": "Clickhouse",
        ...
        "dependencies": ["apache-airflow>=2.0.0", "python-arango>=7.3.2"],
        "devel-dependencies": [],
    }
